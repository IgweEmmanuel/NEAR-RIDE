...
const Footer = () => {
  return (
    <footer className="grid w-full py-8 text-blue-950 px-16 ">
      <div className="container grid justify-center grid-cols-1 gap-8 mx-auto md:grid-cols-3">
        ...
        <div className="text-center md:text-left">
          <h2 className="text-2xl font-bold">NearRide</h2>
          <p className="mt-2">Your go-to platform for a transparent election.</p>
          <p className="mt-4">&copy; {new Date().getFullYear()} NearRide. All Rights Reserved.</p>
        </div>
        ...
        <div className="text-center md:text-left">
          ...
          <div className="flex justify-center space-x-4 md:justify-start">
            <a
              href="#"
              className="text-blue transition duration-300 transform hover:text-blue-400 hover:scale-110"
              aria-label="Twitter"
            >
              <FaTwitter size={24} />
            </a>
